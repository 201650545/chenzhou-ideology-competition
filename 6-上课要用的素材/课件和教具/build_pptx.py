...
def p26b(s):
    """AI 候选卡（60 秒·唯一一处 AI 亮相）：学生先说办法，再挑 AI 的错"""
    header(s, "AI 也给了三条办法", 5, sub="哪一条，明天就能做到？哪一条，说了等于没说？")
    items = [
        ("① 制定学习计划", "每天坚持复习，\n把成绩提上去。"),
        ("② 上课前翻一翻课本", "知道今天要讲什么，\n心里先有个底。"),
        ("③ 下课就去问老师", "把不懂的那一处，\n当天问清楚。"),
    ]
    cards(s, items, M, 2.15, SW - 2 * M, 2.15, cols=3, gap=0.3)
    box(s, M, 4.55, SW - 2 * M, 1.45, CREAM)
    txt(s, M + 0.3, 4.72, SW - 2 * M - 0.6, 1.15,
        "AI 说得好像都对，可好像少了点什么 ——\n少了你们。",
        size=22, color=NAVY, bold=True, spacing=1.4)
    footer(s, "教师：先让学生说自己的办法，再亮这页 · 只停 60 秒 · 三条都可以不要")
...
PLAY = [p01, p03, p05, p07, p09, p10, p12, p13, p14, p17,
        p18, p19, p20, p21, p22, p25, p26, p26b, p27, p29]
