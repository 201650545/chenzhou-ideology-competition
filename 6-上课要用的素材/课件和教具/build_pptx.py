...
def p10(s):
    ...
    footer(s, "教师：语气要平、要慢 —— 这句话是整节课的定调")
...
def p21(s):
    ...
    txt(s, M + 1.3, 4.25, SW - 2 * M - 2.6, 1.6,
        ...
        align=PP_ALIGN.CENTER, spacing=1.4)
    footer(s, "教师：决定权交给学生。允许有人不贴回来 —— 那也很真实。")


def p22(s):
    header(s, "这门课，连着很远的将来", 4, sub="中国人在这些学科里，做过什么")
    pic(s, "img08", M, 1.85, 5.4, 3.3)
    box(s, M + 5.75, 1.85, SW - 2 * M - 5.75, 3.3, NAVY2, line=GOLD, lw=0.75)
    txt(s, M + 6.05, 2.1, SW - 2 * M - 6.35, 2.9,
        "祖冲之把圆周率算到小数点后七位\n"
        "张衡造出地动仪，能测出远方地震\n"
        "袁隆平的杂交水稻，让很多人吃饱饭\n"
        "屠呦呦从青蒿里提取出青蒿素\n"
        "北斗、嫦娥、中国天眼、量子九章……\n\n"
        "这些，都是「数学」「科学」长出来的。", size=15.5, color=WHITE, spacing=1.4)
    footer(s, "中国内容 · 占三分之二")


def p23(s):
    header(s, "这门课，连着整个世界", 4, sub="这些学科，在为全人类做什么")
    pic(s, "img09", M, 1.85, 5.4, 3.3)
    box(s, M + 5.75, 1.85, SW - 2 * M - 5.75, 3.3, NAVY2, line=GOLD, lw=0.75)
    txt(s, M + 6.05, 2.1, SW - 2 * M - 6.35, 2.9,
        "气候变暖，要靠科学来回答\n"
        "疾病与健康，要靠医学来守护\n"
        "粮食与饥饿，要靠农学来解决\n"
        "太空与海洋，要靠一代代人接力\n\n"
        "这些大题，也在等今天坐在教室里的你。", size=15.5, color=WHITE, spacing=1.4)
    footer(s, "全球视野 · 占三分之一")
...
def p29(s):
    ...
    txt(s, M + 1.5, 2.25, SW - 2 * M - 3.0, 2.0,
        ...
        "＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿\n"
        "＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿",
        size=25, color=NAVY, bold=True, spacing=1.5)
